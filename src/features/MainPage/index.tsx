...
const MainPage = () => {
    ...
    useEffect(() => {
        //반응형을 조건으로 secondGridBox slice 3장이 되게 써보자
        const reSize = () => {
                ...
                <div className="mainWrap">
                    <div className="mainBox">
                        ...
                        <div className="explainBox">
                            ...
                            <div>
                                📌 각자의 플레이어 그림카드와 알파벳 그림판에 숨겨진 같은 그림을 찾아 결승점에 먼저
                                도달하는 플레이어가 이기는 게임입니다{' '}
                            </div>
                            <br />

                            <div>🧊 아래의 칸에 2명의 플레이어명을 적고 ⏯️시작버튼을 누르면 게임이 시작됩니다</div>
                            <br />

                            <div>
                                🧊 선(先)플레이어는 작성한 플레이어명 순서와 관계 없이 게임이 시작되면서 랜덤으로
                                지정됩니다
                            </div>
                            <br />
                            ...
                            <div className="pointBox">
                                🧊 두 플레이어의 게임 시작점은{' '}
                                <div className="point">
                                    <img src={point.src.src} />
                                </div>{' '}
                                이 위치하고 있습니다
                            </div>
                            <br />

                            <div className="pointJupmBox">
                                🧊 자신의 순서는 상단 플레이어명 초록색 테두리나 점프하는{' '}
                                <div className="pointJupm">
                                    <img src={point.src.src} />
                                </div>{' '}
                                으로 알 수 있습니다
                            </div>
                            ...
                            <br />
                            <div className="pointJupmBox">
                                🧊 클릭한 알파벳 그림판 뒷면과 점프하는{' '}
                                <div className="pointJupm">
                                    <img src={point.src.src} />
                                </div>
                                이 위치한 그림이 일치하면 한 칸 위로 이동할 수 있습니다{' '}
                            </div>
                            <br />
                            ...
                            <div className="pointBox">
                                ...
                                이 맨 위 결승점에 도달하거나 맨 아래에 도달하면 게임은 종료됩니다
                            </div>
                            <br />
                        </div>
